...
function Userlist() {
     ...
     const handleDelete = async (id) => {
      try {
        ...
        if (confirmDelete) {
          const response = await Api.delete(`http://localhost:8000/api/admin/jadwalpikets/${id}`, {
            headers: {
     ...
     const fetchData = async (pageNumber = 1, keywords = '') => {
         ...
         await Api.get(`http://localhost:8000/api/admin/jadwalpikets`, {
    ...
    return (
      ...
      <div className="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 className="h3 mb-0 text-gray-800">Jadwal Piket Guru</h1>
                      ...
                      <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">
                          <thead>
                              <tr>
                                  ...
                                  <th className="bg-dark text-white">Hari</th>
                                  <th className="bg-dark text-white">Nip</th>
                                  <th className="bg-dark text-white">Nama</th>
